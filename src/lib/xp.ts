...
// Datos puros (LEVELS, getLevel, MAX_LEVEL, tipos) viven en xpLevels.ts
// para que los Client Components puedan importarlos sin arrastrar Prisma
// + nodemailer al bundle del cliente. Aquí los importamos para uso interno
// y los re-exportamos para que el código existente no rompa.
import { LEVELS, MAX_LEVEL, getLevel, type LevelDef, type LevelInfo } from "@/lib/xpLevels"
export { LEVELS, MAX_LEVEL, getLevel }
export type { LevelDef, LevelInfo }
